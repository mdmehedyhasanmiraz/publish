-- Expand handling-editor picker: all four editorial roles + primary role for UI badges.

drop function if exists public.list_handling_editor_candidates();

create function public.list_handling_editor_candidates()
returns table (
  user_id uuid,
  email text,
  display_name text,
