...
export const ARTICLE_VERSION_ROW_SELECT =
  "id, article_id, title, abstract, jats_xml, workflow_status" as const;
...
export async function ensureArticleHasEditVersion(
  ...
  const { data: inserted, error: insErr } = await supabase
    ...
    .insert({
      ...
      abstract,
      jats_xml:
        "<?xml version=\"1.0\" encoding=\"UTF-8\"?><article xmlns:xlink=\"http://www.w3.org/1999/xlink\"><front><article-meta><title-group><article-title>Untitled</article-title></title-group></article-meta></front><body><sec><title>Main text</title><p>Write the article body in JATS XML.</p></sec></body></article>",
