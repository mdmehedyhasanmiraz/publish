...
export default async function EditorArticleEditPage({
  params,
}: {
      ...
      return (
        <div className="mx-auto max-w-2xl p-6">
          <p className="text-sm text-muted-foreground">
            <Link href="/editor/articles" className="text-primary hover:underline">
              ← Article desk
            </Link>
          </p>
    ...
    return (
      <div className="mx-auto max-w-2xl p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Could not load the article version after setup. Refresh the page or return to the article list.
        </p>
      </div>
    );
  }
