  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Accepted manuscripts and published articles. Admin production tools remain under Admin when you have access.
      </p>
      ...
      <div className="mt-5 rounded border bg-white p-4">
        <h3 className="text-sm font-semibold">Published / ahead-of-print</h3>
        <div className="mt-3 grid gap-2">
          {(articles ?? []).length ? (
            (articles ?? []).map((a) => {
